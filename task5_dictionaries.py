...
# a) Create a dictionary of total global sales grouped by genre
sales_by_genre = {}
...
# b) Create a dictionary counting games per publisher
games_per_publisher = {}
...
# c) Create a dictionary for the #1 game and print its items
first_game = video_game_sales[0]

top_game = {
    'name': first_game[NAME],
    'year': first_game[YEAR],
    'genre': first_game[GENRE],
    'publisher': first_game[PUBLISHER],
    'global_sales': first_game[GLOBAL_SALES]
}
