...
# a) Create a list of just the game names and print it
game_names = []
...
# b) Append the new game to the dataset and print the new length
...
# c) Create a tuple for dataset metadata and print it
dataset_info = (len(video_game_sales), 10, 'Video Game Sales')

print(dataset_info)

# Explanation: 
# A tuple is more appropriate than a list for this metadata because tuples are immutable (unchangeable). 
# This prevents accidental modification of the structural facts about our dataset that shouldn't change during our analysis.
