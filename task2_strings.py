...
# a) Extract the name of the 5th game and slice "Pokemon"
game_name = video_game_sales[4][NAME]
extracted_word = game_name[0:7]  # Slices from index 0 up to (but not including) 7
print(extracted_word)

# b) Clean messy_names by stripping whitespace and converting to lowercase
