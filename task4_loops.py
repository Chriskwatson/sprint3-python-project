...
# a) Print name and global sales of games with > 25M global sales
...
# c) Calculate total NA and JP sales and print the higher region
total_na = 0
total_jp = 0
...
# d) Create a list of Nintendo games and print it along with its length
nintendo_games = []
for game in video_game_sales:
